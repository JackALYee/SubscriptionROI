...
col1.metric(label="Monthly cost basis (Ops only)", value=f"{monthly_cost_ops:,.2f} {currency}")
amort_total=monthly_cost_ops+equip_amort_per_month
col2.metric(label="Monthly cost basis (With equipment amortization)", value=f"{amort_total:,.2f} {currency}")
